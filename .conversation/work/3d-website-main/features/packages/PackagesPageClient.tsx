...
// The live packages table has no event_type column, so the old hardcoded
// event-type filter pills are gone — the admin controls which packages show
// here via the active toggle in /admin/packages, and the grid shows them all.
